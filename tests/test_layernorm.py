...
class TestLayerNorm:
    ...
    def test_backward_match(self, batch_size, seq_len, hidden_size):
        ...
        print("triton_ln.weight.grad", triton_ln.weight.grad[0,0,:3])
        print("torch_ln.weight.grad", torch_ln.weight.grad[0,0,:3])
        ...
        print("triton_ln.bias.grad", triton_ln.bias.grad[0,0,:3])
        print("torch_ln.bias.grad", torch_ln.bias.grad[0,0,:3])
        triton.testing.assert_close(
            triton_ln.bias.grad,
            torch_ln.bias.grad,
            rtol=1e-3,
